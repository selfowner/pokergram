...
public class DeckUtils {
    ...
    public static List<?> initializeDeck() {
        ...
        List<String> deck52 = new ArrayList(52);
        ...
        for (Integer i = 0; i < cardSuits.length; i++) {
            for (Integer y = 0; y < cardRanks.length; y++) {
                ...
                System.out.println("index: " + Integer.parseInt(i.toString())+Integer.parseInt(y.toString()));
                System.out.println("value: " + cardRanks[y].toString() + cardSuits[i].toString());
                deck52.add(
                        cardRanks[y].toString() + cardSuits[i].toString());
